...
class Disease(models.Model):
    ...
    # p = models.ForeignKey(Prescription, on_delete=models.CASCADE, null=True)
...
class Covid(models.Model):
    ...
    n_date = models.DateField(auto_now=False, auto_now_add=False, null=True, blank=True)
...
class TimeTable(models.Model):
    ...
    def __str__(self):
        return str(self.emp) + ' ' + '(' + str(self.day) + ')'
...
class MostCommonDisease(models.Model):
    dname = models.CharField(max_length=30, null=False, primary_key=True)
...
class CovidEmpWorkingHoursStat(models.Model):
    hours_per_week = models.DecimalField(max_digits=5, decimal_places=2, primary_key=True)
...
class MostFreqillEmp(models.Model):
    ...
    # def __str__(self):
    #     return str(self.tc) + " - " + str(self.disease_count)
...
class MostFreqillEmpsCovid(models.Model):
    ...
    # def __str__(self):
    #     return str(self.tc) + " - " + self.first_name + " " + self.last_name
...
class NonVaccinatedEmpDisPre(models.Model):
    ...
    prescription_id = models.CharField(max_length=5, primary_key=True)
    ...
    # def __str__(self):
    #     return self.dname + " - " + str(self.prescription_id)


class MostCommonlyUsedDrug(models.Model):
    drug_name = models.CharField(max_length=32, primary_key=True)
    drug_count = models.BigIntegerField()
...
class MostCommonlyUsedDrugsUser(models.Model):
    ...
    class Meta:
        managed = False
        db_table = "most_common_drugs_user"
